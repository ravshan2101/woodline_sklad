...
//
//     final zayavkiGetModel = zayavkiGetModelFromJson(jsonString);

import 'dart:convert';

ZayavkiGetModel zayavkiGetModelFromJson(String str) =>
    ZayavkiGetModel.fromJson(json.decode(str));

String zayavkiGetModelToJson(ZayavkiGetModel data) =>
    json.encode(data.toJson());

class ZayavkiGetModel {
  ...
  factory ZayavkiGetModel.fromJson(Map<String, dynamic> json) =>
      ZayavkiGetModel(

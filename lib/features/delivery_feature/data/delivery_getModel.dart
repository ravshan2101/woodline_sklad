...
//
//     final deliveredModel = deliveredModelFromJson(jsonString);

import 'dart:convert';

DeliveredModel deliveredModelFromJson(String str) =>
    DeliveredModel.fromJson(json.decode(str));

String deliveredModelToJson(DeliveredModel data) => json.encode(data.toJson());
